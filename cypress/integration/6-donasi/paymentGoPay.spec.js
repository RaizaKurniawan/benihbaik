...
describe("Execute Donasi Payment Gopay", function(){
    ...
    it("Pilih Payment Gopay", function() {
       
        const gopaypayment = new Donasi();
        gopaypayment.cookieSet();
        gopaypayment.gopaypayment().click();
    })
