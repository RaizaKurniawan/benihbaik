...
describe("Execute Donasi Payment Transfer Mandiri", function(){
    ...
    it("Pilih Payment Transfer Mandiri", function() {
        cy.scrollTo('bottom');
        const bankMandiri = new Donasi();
        bankMandiri.cookieSet();
        
        bankMandiri.bankMandiri().click();
    })
