...
describe("Execute Donasi Payment VA LAinnya", function(){
    ...
    it("Pilih Payment VA Lainnya", function() {
        cy.scrollTo('bottom');
        const virtuallainnya = new Donasi();
        virtuallainnya.cookieSet();
        
        virtuallainnya.virtuallainnya().click();
    })
