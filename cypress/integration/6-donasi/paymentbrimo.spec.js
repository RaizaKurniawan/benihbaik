...
describe("Execute Donasi Payment BRIMobile", function(){
    ...
    it("Pilih Payment BRIMO", function() {
        cy.scrollTo('bottom');
        const brimopayment = new Donasi();
        brimopayment.cookieSet();
        
        brimopayment.brimopayment().click();
    })
