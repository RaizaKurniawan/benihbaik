...
describe("Execute Donasi Payment Transfer OCBC NISP", function(){
    ...
    it("Pilih Payment Transfer OCBC NISP", function() {
        cy.scrollTo('bottom');
        const bankOCBC = new Donasi();
        bankOCBC.cookieSet();
        
        bankOCBC.bankOCBC().click();
    })
