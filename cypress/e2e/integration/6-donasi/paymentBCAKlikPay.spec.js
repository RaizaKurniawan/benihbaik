...
describe("Execute Donasi Payment BCA Klik Pay", function(){
    ...
    it("Pilih Payment BCA Klik Pay", function() {
       
        const bcaklikpay = new Donasi();
        bcaklikpay.cookieSet();
        bcaklikpay.bcaklikpay().click();
    })
