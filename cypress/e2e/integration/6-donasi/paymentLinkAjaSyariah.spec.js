...
describe("Execute Donasi Payment LinkAja Syariah", function(){
    ...
    it("Pilih Payment LinkAja Syariah", function() {
        cy.scrollTo('bottom');
        const linkajasyariah = new Donasi();
        linkajasyariah.cookieSet();
        
        linkajasyariah.linkajasyariah().click();
    })
