...
describe("Execute Donasi Payment DANA", function(){
    ...
    it("Pilih Payment DANA", function() {
       
        const danapayment = new Donasi();
        danapayment.cookieSet();
        danapayment.danapayment().click();
    })
